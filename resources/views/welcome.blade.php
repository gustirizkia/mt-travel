...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/images/logo_mt2.jpg" />

    <!-- Primary Meta Tags -->
    <title>Explore Top Destination On Lebak Banten</title>
    <meta name="title" content="Explore Top Destination On Lebak Banten">
    ...
    <meta property="og:title" content="Explore Top Destination On Lebak Banten">
    ...
    <meta property="twitter:title" content="Explore Top Destination On Lebak Banten">
    <meta property="twitter:description" content="Explore The Beautiful World
    As Easy One Click You will see beautiful
    moment you never see before">
    <meta property="twitter:image" content="{{ asset('assets/images/logo_mt2.jpg') }}">

    <title>MT TRAVEL</title>
    <link
  ...
  <body>
    ...
    <footer>
        ...
        <div class="text-center text-secondary mt-3">
            Copyright {{ \Carbon\Carbon::now()->format('Y') }} • All rights reserved • MTTRAVEL
        </div>
    </footer>
    <script
